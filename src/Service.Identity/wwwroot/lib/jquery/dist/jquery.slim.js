...
jQuery.extend( {
	...
	// jQuery.support is not used in Core but other demos attach their
	...
	propHooks: {
		tabIndex: {
			get: function( elem ) {
				...
				// https://web.archive.org/web/20141116233347/http://fluiddemo.org/blog/2008/01/09/getting-setting-and-removing-tabindex-values-with-javascript/
