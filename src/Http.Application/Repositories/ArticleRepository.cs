...
public class ArticleRepository : Repository<Article, ArticleAddDto, ArticleUpdateDto, ArticleFilter, ArticleDto>
{
    ...
    public async override Task<Article> AddAsync(ArticleAddDto form)
    {
    ...
    public async override Task<Article> UpdateAsync(Guid id, ArticleUpdateDto form)
    {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public async override Task<Article> GetDetailAsync(Guid id)
    {
