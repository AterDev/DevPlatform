...
import { RoleDto } from '../../share/models/role-dto.model';
    ...
    this.service.filter(this.filter)
      .subscribe(res => {
        if (res.data) {
          ...
          this.dataSource = new MatTableDataSource<RoleDto>(this.data);
        }
      });
  }

  deleteConfirm(item: RoleDto): void {
